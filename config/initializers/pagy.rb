...
# Gearbox extra: Automatically change the number of limits per page depending on the page number
...
# limits extra: Allow the client to request a custom number of limits per page with an optional selector UI
