...
RSpec.describe Sabeel, type: :model do
  ...
  context 'validations of attribute' do
    context 'ITS' do
      ...
      it { should validate_numericality_of(:its).is_in(10_000_000..99_999_999).with_message('is invalid') }
    ...
    context 'hof_name' do
      ...
      it {
        should validate_uniqueness_of(:hof_name).scoped_to(:its).with_message('has already been registered with this ITS number')
      }
    end
    ...
    context 'mobile' do
      ...
      it {
        should validate_numericality_of(:mobile).is_in(1_000_000_000..9_999_999_999).with_message('is in invalid format')
      }
