...
SimpleForm.setup do |config|
  ...
  config.wrappers :horizontal_form, tag: "div", class: "form-group row", error_class: "form-group-invalid", valid_class: "form-group-valid" do |b|
    ...
    b.wrapper :grid_wrapper, tag: "div", class: "col-md-8 mt-md-4" do |ba|
      ba.use :input, class: "form-control border border-2 border-info-subtle rounded-3 fst-italic fw-medium text-secondary focus-ring focus-ring-secondary", error_class: "is-invalid border-danger-subtle", valid_class: "is-valid text-success"
  ...
  config.wrappers :horizontal_collection_inline, item_wrapper_class: "form-check form-check-inline", item_label_class: "form-check-label fst-italic fw-medium text-secondary", tag: "div", class: "form-group row", error_class: "form-group-invalid", valid_class: "form-group-valid" do |b|
    ...
    b.use :label, class: "col-md-4 fw-medium fs-5 mt-4 text-success"
    b.wrapper :grid_wrapper, tag: "div", class: "col-md-8 mt-md-4" do |ba|
      ba.use :input, class: "form-check-input border border-2 border-info-subtle focus-ring focus-ring-secondary", error_class: "is-invalid", valid_class: "is-valid"
      ba.use :hint, wrap_with: {tag: "small", class: "text-success fst-italic mb-0"}
  ...
  config.wrappers :vertical_multi_select, tag: "div", class: "form-group mb-3", error_class: "form-group-invalid", valid_class: "form-group-valid" do |b|
    ...
    b.wrapper tag: "div", class: "d-flex flex-row justify-content-between align-items-center" do |ba|
      ba.use :input, class: "form-select border border-2 border-info-subtle rounded-3 mx-1 mt-2 fst-italic fw-medium text-secondary focus-ring focus-ring-secondary", error_class: "is-invalid border-danger-subtle", valid_class: "is-valid text-success"
    end
